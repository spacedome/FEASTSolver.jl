...
- [ ] Implement SS, Sakurai subspace iteration algorithms
  ...
  - Current direction: prioritize natural realization/gauge control, local contour decomposition, and a true dual/Petrov-Galerkin nonlinear extraction over ad-hoc scalar deflation. Next implementation target is a real chart abstraction with diagnostics: contour, coordinate map, moment basis or offset, extraction, gauge, rank/count estimate, physical observability, and merge policy. If this stalls, inspect NEP-PACK and adjacent NEP/SS/Beyn literature for deflation techniques as a fallback.
