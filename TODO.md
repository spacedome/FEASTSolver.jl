...
- [ ] Implement SS, Sakurai subspace iteration algorithms
  ...
  - Next nonlinear experiments: design conservative deflation/replacement policies for moment states; track singular-value gaps and Ritz persistence; return to the scalar `sin(z)` stress tests after the polynomial gauge/deflation behavior is understood.
