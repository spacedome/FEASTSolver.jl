...
- Oracle-free target completion and stopping are now covered by the radius-20
  ...
  multi-delay, near-pole rational, and duplicate-delay multiplicity controls,
  but not yet generalized across every experiment harness. Exact roots are
  still used broadly for validation and for supervised controls.
