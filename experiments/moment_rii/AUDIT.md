...
- Sparse and distributed moment-NLFEAST are not implemented. The experiment now
  ...
  matching the serial update. It deliberately does not yet provide symbolic
  sparse reuse, reusable sparse work buffers, nonlinear sparse gallery coverage,
  or benchmark-level performance claims.
