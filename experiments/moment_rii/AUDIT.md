...
1. Continue tightening the experiment interface around a small set of stable
   ...
   now pass basis/extractor/update objects through directly. Older helper
