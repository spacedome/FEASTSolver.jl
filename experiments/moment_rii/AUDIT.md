...
- Sparse and distributed moment-NLFEAST are not implemented. The experiment now
  ...
  reduces the returned Laurent blocks to match the serial update. It is not yet
  a sparse plan with reusable sparse factorizations or benchmark-level
  performance claims.
