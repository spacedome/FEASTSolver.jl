...
1. Convert the repeated count-driven experiment patterns into a smaller
   reusable experiment-policy object so additional problem classes can be added
   without copying large keyword blocks.
