...
- Sparse and distributed moment-NLFEAST are not implemented. The experiment now
  ...
  worker-owned contour factors. It deliberately does not yet provide symbolic
  sparse reuse, reusable sparse work buffers, realistic sparse gallery
