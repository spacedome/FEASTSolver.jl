...
- Sparse and distributed moment-NLFEAST are not implemented. The experiment now
  ...
  factors and node-local solve buffers. It deliberately does not yet provide
  full reusable sparse workspaces, broad realistic sparse gallery coverage, or
