...
- Sparse and distributed moment-NLFEAST are not implemented. The experiment now
  ...
  materializer and moment pipeline. It deliberately does not yet provide
  symbolic sparse reuse, reusable sparse work buffers, sparse nonlinear worker
  storage, or benchmark-level performance claims.
