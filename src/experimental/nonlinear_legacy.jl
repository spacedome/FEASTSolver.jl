"""
Legacy nonlinear FEAST prototypes.

These functions predate the finalized nonlinear FEAST implementation. They are
kept available for old experiments, but should not drive the main solver layout.
"""
